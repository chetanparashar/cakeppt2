...
echo $this->Html->Tag('title', 'Send Mail Example');
...
echo $this->Form->create(false, array("id" => "uploadfilefrm", 'type' =>'file' ,"target" => "_self", "autocomplete" => "off"));
echo $this->Form->file('file.',array('multiple'=>true));
/*?>

<input type="input" name="name" style = "text-align: center;" requried> <br><br>
<input type="file"  multiple name="img." style = "text-align: center;" requried>
<?php*/
echo $this->Form->end(array('label' => 'Send Mail', "style" => "padding: 5px;margin: 10px;"));
