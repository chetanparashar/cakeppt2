...
class PwAgentInvoice extends HTML2FPDF {
    ...
    public function GeneratePDF($result, $saledate) {
        $headinfo = "Sugal &amp; Damani Utility Services Pvt. Ltd.
                <br>Reg Off: 6/35, W.E.A Karol bagh,
                <br>New Delhi 110005
                <br>Web site: www.payworldindia.com
                <br>Email: contact@payworldindia.com
    ...
    <tbody>
        ...
        <tr ><td colspan="2"  height=40 align="center" style="font-size:20px" ><font size=26><b>INVOICE SUMMARY/ DEBIT NOTE/ CREDIT NOTE</b></font></td>
    
       </tr>
        <tr>
            <td  width="70%"><b>Invoice No. :</b>' . strtoupper(date("Ymd", strtotime($saledate)) . "/" . $row['serno'] . "/" . str_pad($invoice, 3, '0', STR_PAD_LEFT)) . '</td>
            <td style="text-align: left;"><b>Invoice Date : </b>' . $invdate . '</td>
        </tr>
        <tr >
            <td><b>' . $row['partyname'] . '</b></td>
        ...
        <tr>
            <td colspan=2 ><b>PAN Card No :</b>' . $row['panno'] . '</td>
        </tr>
        <tr color="red">
            <td colspan=2 height=40 style="color: #606;  font-size: 10px;  margin: 5px 0px;"  ><font color="#606" ><b>We are debiting your A/c on ' . $saledate . '</b></font></td>
        </tr>
    </tbody>
</table>';
            $totalrow = array();
            ...
            $html .= '<p style="color: red;text-align: left;padding-left: 10px;">* This is Computer generated invoice summary / Debit note / credit note does not required any Signature</p>';
            $this->Ln(0);
            $this->lineheight = 3.5;
            $this->WriteHTML($html);
